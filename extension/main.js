(function() {
    ...
    var application = 'com.timedoctor.desktop';
    var port = null;
    ...
    document.getElementById('connect').addEventListener('click', function() {
        ...
        port.onDisconnect.addListener(function(e) {
            log('unexpected disconnect: ' + application + ' ' + chrome.runtime.lastError.message);
    ...
    document.getElementById('disconnect').addEventListener('click', function() {
        log('port.disconnect: ' + chrome.runtime.lastError.message);
